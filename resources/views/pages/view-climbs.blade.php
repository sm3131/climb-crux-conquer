...
@section('content')
    <div class="bg-slate-blue flex flex-col gap-2 px-24 items-center">
        ...
        <div class="flex flex-row w-full border-4 mb-4 mt-0 pr-2  border-orange bg-gray gap-4 justify-start">
            <img src="{{URL::asset('images/mr.slate.png')}}" alt="rock climbing route mr.slate in flagstaff, az">
            <div class="flex flex-col md:flex-row flex-wrap gap-2 md:gap-11 items-center">
                <div class="text-center w-80 sm:text-left mt-1">
                ...
                <div class="text-center w-60 justify-self-end">
                    <a href="/single-climb"><h3 class="text-2xl md:mb-2 mr-4">Climb <br> Description</h3></a>
                    <a href="/single-climb"><h3 class="text-2xl md:mb-2 mr-4">Beta & Comments</h3></a>
                </div>
                <div class="sm:self-left w-20 p-2">
