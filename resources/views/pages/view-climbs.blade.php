    ...
    <div class="bg-slate-blue flex flex-col gap-2 px-24 items-center">
        ...
        @foreach ($climbs as $climb)
            <div
                ...
                <img src="{{ asset('storage/' . $climb->climb_image) }}" alt="{{$climb->climb_name}} rock climbing route at {{$climb->climb_location}}">
                <div class="flex flex-col md:flex-row flex-wrap gap-2 items-center">
                    ...
                    <div class="text-center w-60 justify-self-end">
                        <a href="/single-climb/{{ $climb->id }}">
                            <h3 class="text-2xl md:mb-2 mr-4 border-2 rounded-md bg-orange hover:bg-slate-blue">Climb <br> Description</h3>
                        </a>
                        <a href="/single-climb/{{ $climb->id }}">
                            <h3 class="text-2xl md:mb-2 mr-4 border-2 rounded-md bg-orange hover:bg-slate-blue">Beta & Comments</h3>
                        </a>
                    </div>
